...
<body>
	...
	<h5>
		Cadastro de novos usuários
			...
			<label for="tipoConta">Tipo da conta: </label> <select
				class="form-select" name="tipoConta" aria-label="Default select example">
			...
			<a href="${pageContext.request.contextPath}/principal/login.jsp">Já possui conta? Realize o login</a> <br> <input
				type="submit" value="Cadastrar" class="btn btn-outline-dark mt-auto">
